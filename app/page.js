...
import { ArrowRight, Gavel, Stethoscope } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                Terhubung dengan advokat
                <br />
                <span className="gradient-title">kapan saja, dimana saja</span>
              </h1>
              <p className="text-muted-foreground text-lg md:text-xl max-w-md">
                Tentukan jadwal, konsultasi via chat, dan kelola perjalanan
                hukum anda dalam satu platform.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <Link href="/lawyers">Cari Advokat</Link>
                </Button>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Kenapa Kamu Sangat Harus Pakai
              <br />
              Platform Yang Keren Ini?
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Sejujurnya aplikasi kita ini sering bermasalah. Kadang-kadang gak
              bisa submit, kadang dibukanya lambat, kadang tiba-tiba logout
      ...
      <section id="pricing" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Main catur sambil bersepeda,
              <br />
              beda harga beda fitur
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Aplikasi ini gratis sebenernya bro. Tapi kalo mau bayar gapapa
              juga sih,
              <br />
              untuk gantinya kami kasih fitur spesial buat kamu!
            </p>
          </div>
            ...
            <Card className="mt-12 bg-muted/20 border-emerald-900/30">
              <CardHeader>
                <CardTitle className="text-xl font-semibold text-white flex items-center">
                  ...
                  Gimana Sih Cara Kerja Sistem Kami?
                </CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              ...
              <br />
              ditampilkan disini semuanya asli tanpa redaksana.
            </p>
          </div>
            ...
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              <div className="max-w-2xl relative z-10">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Please daftar lah di website ini trus lakuin konsultasi, udah
                  susah-susah buat, mana pas bikin sampe begadang, terus juga
                  ditambah weekend. Jadi, please segera daftar lah ya.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    asChild
