    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        <Label htmlFor="description">
          Jelaskan topik permasalahan Anda (optional)
        </Label>
        <Textarea
          id="description"
          placeholder="Harap berikan rincian tentang permasalahan Anda atau apa yang ingin Anda diskusikan dalam konsultasi..."
          value={description}
          onChange={(e) => setDescription(e.target.value)}
          className="bg-background border-emerald-900/20 h-32"
        />
        <p className="text-sm text-muted-foreground">
          Informasi ini akan dibagikan kepada advokat sebelum konsultasi dimulai.
        </p>
      </div>
